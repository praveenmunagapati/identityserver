...
class userview(object):
    ...
    @staticmethod
    def create(addresses, avatar, bankaccounts, digitalwallet, emailaddresses, firstname, lastname, ownerof, phonenumbers, username, validatedemailaddresses, validatedphonenumbers, facebook=None, github=None, publicKeys=None):
        """
