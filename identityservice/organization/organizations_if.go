...
func OrganizationsInterfaceRoutes(r *mux.Router, i OrganizationsInterface) {
	...
	r.Handle("/organizations/{globalid}/members/{username}", alice.New(newOauth2oauth_2_0Middleware([]string{"organization:admin"}).Handler).Then(http.HandlerFunc(i.globalidmembersusernameDelete))).Methods("DELETE")
	r.Handle("/organizations/{globalid}/owners", alice.New(newOauth2oauth_2_0Middleware([]string{"organization:admin"}).Handler).Then(http.HandlerFunc(i.globalidownersPost))).Methods("POST")
	r.Handle("/organizations/{globalid}/owners/{username}", alice.New(newOauth2oauth_2_0Middleware([]string{"organization:admin"}).Handler).Then(http.HandlerFunc(i.globalidownersusernameDelete))).Methods("DELETE")
	r.Handle("/organizations/{globalid}/contracts", alice.New(newOauth2oauth_2_0Middleware([]string{"organization:admin", "organization:contracts:read"}).Handler).Then(http.HandlerFunc(i.GetContracts))).Methods("GET")
	r.Handle("/organizations/{globalid}/invitations", alice.New(newOauth2oauth_2_0Middleware([]string{"organization:admin"}).Handler).Then(http.HandlerFunc(i.GetPendingInvitations))).Methods("GET")
	r.Handle("/organizations/{globalid}/invitations/{username}", alice.New(newOauth2oauth_2_0Middleware([]string{"organization:admin"}).Handler).Then(http.HandlerFunc(i.RemovePendingInvitation))).Methods("DELETE")
	r.Handle("/organizations/{globalid}/apisecrets", alice.New(newOauth2oauth_2_0Middleware([]string{"organization:admin"}).Handler).Then(http.HandlerFunc(i.GetAPISecretLabels))).Methods("GET")
	r.Handle("/organizations/{globalid}/apisecrets", alice.New(newOauth2oauth_2_0Middleware([]string{"organization:admin"}).Handler).Then(http.HandlerFunc(i.CreateNewAPISecret))).Methods("POST")
	r.Handle("/organizations/{globalid}/apisecrets/{label}", alice.New(newOauth2oauth_2_0Middleware([]string{"organization:admin"}).Handler).Then(http.HandlerFunc(i.GetAPISecret))).Methods("GET")
	r.Handle("/organizations/{globalid}/apisecrets/{label}", alice.New(newOauth2oauth_2_0Middleware([]string{"organization:admin"}).Handler).Then(http.HandlerFunc(i.UpdateAPISecretLabel))).Methods("PUT")
	r.Handle("/organizations/{globalid}/apisecrets/{label}", alice.New(newOauth2oauth_2_0Middleware([]string{"organization:admin"}).Handler).Then(http.HandlerFunc(i.DeleteAPISecret))).Methods("DELETE")
}
