...
func homeHtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "home.html", size: 7439, mode: os.FileMode(420), modTime: time.Unix(1459324694, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
