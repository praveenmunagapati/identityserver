...
func homeHtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "home.html", size: 6402, mode: os.FileMode(420), modTime: time.Unix(1458221590, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
