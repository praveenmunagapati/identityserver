...
//go:generate go-bindata -pkg html -o ./packaged/html/html.go index.html registration.html login.html base.html error.html apidocumentation.html smsconfirmation.html
